// This project uses 3 laser sensors to and map the distance
...
void setup()
{
  ...
  // define the analog output pins (choise of 3,5,6,9,10,11)
...
//  Serial.println("s2set");
  ...
  pinMode(sh3, INPUT_PULLUP);
  delay(150);
  s3.init(true);
  Serial.println("check3");
  delay(100);
  s3.setAddress((uint8_t)24);
//  Serial.println("s3set");  
...
void loop()
{
  ...
  Serial.print(dis3);
  Serial.print(" vib:");
  Serial.print(motorControl(dis3));
  Serial.print(" ");
  Serial.println();
//  delay(200);
}
